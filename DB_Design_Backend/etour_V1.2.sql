...
INSERT INTO `categorysubcategory` VALUES (1,1,'International',NULL,NULL,NULL,NULL,'no');
...
INSERT INTO `customerdetail` VALUES (1,'asd','asd','asd','asd','sd','asd','asd','44','444','4444444444','2019-12-31 18:30:00');
...
INSERT INTO `datepackagedetail` VALUES (1,'2020-01-27','2020-01-24',1,NULL);
...
INSERT INTO `itinerary` VALUES (1,1,'london',NULL,NULL);
...
INSERT INTO `packagecompletedetail` VALUES (1,'Europe',NULL,1,NULL);
...
CREATE TABLE `passengerdetail` (
  ...
  CONSTRAINT `passengerdetail_ibfk_1` FOREIGN KEY (`packageid`) REFERENCES `packagecompletedetail` (`packageid`)
...
INSERT INTO `passengerdetail` VALUES (6,'omkar','2015-05-15','single',200.000,NULL,NULL,NULL,NULL,NULL,1);
...
CREATE TABLE `pricedetail` (
  ...
  `tourcost` decimal(10,3) DEFAULT NULL,
  `singleperson` decimal(10,3) DEFAULT NULL,
  `Adults` decimal(10,3) DEFAULT NULL,
  `childwobed` decimal(10,3) DEFAULT NULL,
  `childwithbed` decimal(10,3) DEFAULT NULL,
  PRIMARY KEY (`priceid`),
...
INSERT INTO `pricedetail` VALUES (0,1,6700.000,6000.000,5000.000,3000.000,4000.000);
...
-- Dump completed on 2020-01-23 12:53:50
