...
CREATE TABLE `bookingdetail` (
  ...
  CONSTRAINT `bookingdetail_ibfk_1` FOREIGN KEY (`packageid`) REFERENCES `packagecompletedetail` (`packageid`),
  CONSTRAINT `customerid` FOREIGN KEY (`customerid`) REFERENCES `customerdetail` (`customerid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `datepackageid` FOREIGN KEY (`datepackageid`) REFERENCES `datepackagedetail` (`datepackageid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `passengerid` FOREIGN KEY (`passengerid`) REFERENCES `passengerdetail` (`passengerid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `itinerary` (
  ...
  PRIMARY KEY (`dayid`,`packageid`),
  KEY `packageid` (`packageid`),
  CONSTRAINT `itinerary_ibfk_1` FOREIGN KEY (`packageid`) REFERENCES `packagecompletedetail` (`packageid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `passengerdetail` (
  ...
  CONSTRAINT `bookingid` FOREIGN KEY (`bookingid`) REFERENCES `bookingdetail` (`bookingid`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pricedetail` (
  ...
  `packageid` int(11) NOT NULL DEFAULT '0',
  `adultprice` decimal(10,3) NOT NULL,
  `childrenprice` decimal(10,3) NOT NULL,
  `additionalcharges` decimal(10,3) NOT NULL,
  PRIMARY KEY (`priceid`,`packageid`),
  KEY `packageid` (`packageid`),
  CONSTRAINT `pricedetail_ibfk_1` FOREIGN KEY (`packageid`) REFERENCES `packagecompletedetail` (`packageid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-01-17 16:56:45
